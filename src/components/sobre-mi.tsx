export default function SobreMi() {
    return (
        <section className='text-center space-y-4 text-pretty mt-10 max-w-4xl mx-auto px-6'>
            <p className='text-xs uppercase'>Experto en diseño web e implementación de E-commerce (tiendas en línea).</p>
            <p className='text-sm text-pretty'>
                Tengo 32 años, he trabajado de forma independiente hace más de 8 años, fundador y cofundador de varias pymes locales como Softem{" "}
                <span className='text-xs italic'>(agencia de marketing digital - 2015)</span>, Soy Cervecero SpA{" "}
