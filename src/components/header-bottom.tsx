    ...
    return (
        <div className='relative pt-20 pb-6 text-white rounded-b-medium md:rounded-b-3xl'>
            ...
            <Image
                ...
                className='absolute inset-0 mx-auto z-0 w-56 h-56 rounded-full object-cover -top-[112px] drop-shadow-2xl border-t-8 border-t-amber-400 border-b-8 border-b-sky-400'
